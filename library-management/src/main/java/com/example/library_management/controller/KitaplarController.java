...
public class KitaplarController {
    ...
    public KitaplarController(KitaplarRepository kitaplarRepository,
    ...
    public String deleteKitap(@PathVariable int id) {
        kitaplarRepository.deleteById(id);
        return "redirect:/admin/kitaplar";
    }
    ...
    public String updateKitap(
        ...
        if (mevcut != null) {
            ...
            if (form.getYil() > currentYear) {
                return "redirect:/admin/kitaplar/duzenle/" + id;
            }
